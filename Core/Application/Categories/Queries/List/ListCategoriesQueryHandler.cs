namespace Application.Categories.Queries.List
{
    ...
    public class
        ListCategoriesQueryHandler : IRequestHandler<ListCategoriesListQuery, MultiResponse<ListCategoriesResponseModel>>
    {
        ...
        public async Task<MultiResponse<ListCategoriesResponseModel>> Handle(ListCategoriesListQuery request,
