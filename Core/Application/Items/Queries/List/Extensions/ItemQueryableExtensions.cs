...
namespace Application.Items.Queries.List.Extensions
{
    public static class ItemQueryableExtensions
    {
        public static IQueryable<Item> ApplyFilters(this IQueryable<Item> query, ListItemsQuery request)
        {
        ...
        public static IQueryable<Item> ApplySorting(this IQueryable<Item> query, ListItemsQuery request)
        {
