namespace Application
{
    public static class ExceptionMessages
    {
        public static class Admin
        {
            ...
            public const string UserNotAddedSuccessfullyToRole = "Something went wrong while adding user to  role!";
            public const string CannotRemoveSelfFromRole = "You can not remove yourself from role !";
            public const string NotInRole = " is not .";

            public const string UserNotRemovedSuccessfullyFromRole =
                "Something went wrong while removing user from  role!";
        }
